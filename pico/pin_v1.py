...
probe1path = {"probe":1, "switch":11, "mux":0, "pad":1}
probe2path = {"probe":2, "switch": 0, "mux":-1, "pad":HV}
probe3path = {"probe":3, "switch":21, "mux":3, "pad":3}
probe4path = {"probe":4, "switch":12, "mux":1, "pad":2}
probe5path = {"probe":5, "switch":23, "mux":5, "pad":GDR}
probe6path = {"probe":6, "switch":22, "mux":4, "pad":4}
empty      = {"probe":-1, "switch":13, "mux":2, "pad":-1}

probe_path = [probe1path, probe2path, probe3path, probe4path, probe5path, probe6path, empty]
